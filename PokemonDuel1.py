...
if enemy == pokemon1:
    enemy = random.choice([Absol, Charizard, Blastoise, Venasaur, Pikachu])
print "Your Rival chose: %s" % (enemy)
...
for turn in range(1000):
    ...
    if pokemon1 == Charizard:
        cAttacks = raw_input(('Flamethrower Ember Firekick Flame Tempest: '))
        ...
        if pokemon1 == Blastoise:
            bAttacks = raw_input(('WaterCanon Squirt Tackle Hydropump: '))
        ...
        if pokemon1 == Venasaur:
            vAttacks = raw_input(('VineWhip RazorLeaf SolarBeam Cut: '))
            ...
            if vAttacks == vinewhip:
                ...
                if vAttacks == razorleaf:
                    ...
                    print "Please type the full attack"            
        if pokemon1 == Absol:
            AbsolAttacks = raw_input(('Bite HyperBeam Tackle Slash:  '))
            ...
            if AbsolAttacks == bite:
                ...
                if AbsolAttacks == hyperbeam:
                    ...
                    print "Please type the full attack"            
        if pokemon1 == Pikachu:
            PikachuAttack = raw_input(('Slam Thunder Thunderbolt Tackle: '))
...
if enemy == Charizard:
    enemyAttacks == random.choice([Flamethrower, Ember, Firekick, Flametempest])
    Flamethrower = random.randint(20,30)
    Ember = random.randint(10,15)
    Firekick = random.randint(15,20)
    Flametempest = random.randint(20,25)
